...
namespace eval ::optrace {
  variable script "X:/2-Github/CPU_Design_Based_on_FPGA/CPU_design/CPU.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet X:/2-Github/CPU_Design_Based_on_FPGA/CPU_design/CPU.runs/synth_1/top.dcp
