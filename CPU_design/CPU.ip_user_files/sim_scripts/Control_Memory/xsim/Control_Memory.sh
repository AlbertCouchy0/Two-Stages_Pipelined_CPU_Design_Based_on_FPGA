...
#
# Script generated by Vivado on Sat Apr 05 18:45:59 +0800 2025
...
#
# Usage        : Control_Memory.sh
#                Control_Memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Control_Memory.sh [-reset_run]
#                Control_Memory.sh [-reset_log]
#                Control_Memory.sh [-help]
#
...
# script info
echo -e "Control_Memory.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Control_Memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Control_Memory xil_defaultlib.Control_Memory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Control_Memory -key {Behavioral:sim_1:Functional:Control_Memory} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="X:/0-NewSoftAddress/1-Vivado/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Control_Memory.wdb xsim.dir libdpi.so)
...
Usage: Control_Memory.sh [-step]\n\
Usage: Control_Memory.sh [-lib_map_path]\n\
Usage: Control_Memory.sh [-reset_run]\n\
Usage: Control_Memory.sh [-reset_log]\n\
Usage: Control_Memory.sh [-keep_index]\n\
